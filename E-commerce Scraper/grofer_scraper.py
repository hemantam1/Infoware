...
if __name__ == "__main__":
    products = pd.read_csv("Generated_Files/grofer.csv")
    pincodes_df = pd.read_csv('Generated_Files/pincodes/pincodes_grofers.xlsx')
    with open('./Generated_Files/grofer_scraper.csv', 'w', newline='') as f:
        writer = csv.writer(f)
